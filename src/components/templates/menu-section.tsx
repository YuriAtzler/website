...
export function MenuSection() {
  return (
    <section id="menu" className="w-full py-24 flex" aria-label="Menu">
      <div className="container flex flex-col w-full gap-6">
        ...
        <Tabs className="mx-auto" variant="underlined">
...
function MenuItem() {
  return (
    <div className="col-span-1 gap-3 flex p-3 rounded items-center hover:bg-gray-2">
